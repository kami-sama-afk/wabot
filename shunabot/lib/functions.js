...
const wait = async (media) => new Promise(async (resolve, reject) => {
    ...
    try {
    	...
    	let belief = () => similarity < 0.89 ? "⚠ *Similaridade* abaixo de 0,89\n" : ""
...
~> Temporada: *${season}*`});
		...
		console.log(e)
		reject(`*Resultado ou semelhantes não encontrado! 😖*`)
	}
})
...
const simih = async (text) => {
	try {
		...
		return '*Algo de rrado não deu certo kkk*'
	}
}
...
module.exports = { translate, wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close }
